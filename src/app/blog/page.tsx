...
const OurProcesSection = () => {
  ...
  const images = [
    { src: "/images/about/about-image.svg", alt: "about-image", className: "drop-shadow-three dark:hidden dark:drop-shadow-none" },
    { src: "/images/about/about-image-dark.svg", alt: "about-image", className: "hidden drop-shadow-three dark:block dark:drop-shadow-none" },
  ];
  ...
  const goToNext = () => {
    setCurrentIndex((prevIndex) => (prevIndex + 1) % images.length); // Loop forwards
  };
        ...
        <div className="container">
          <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
            <div className="-mx-4 flex flex-wrap items-center">
              ...
              {/* Swiper for images */}
              <div className="w-full px-4 lg:w-1/2">
      <div className="relative mx-auto max-w-[500px] lg:mr-0 overflow-hidden">
